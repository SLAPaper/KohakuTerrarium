export default {
  ...
  "sessions.workdirMissingTitle": "작업 디렉터리가 없습니다",
  "sessions.workdirMissingPrompt":
    "저장된 작업 디렉터리가 더 이상 존재하지 않습니다: {pwd}. 새 작업 디렉터리를 입력하세요(비워 두면 서버 기본값 사용):",
  "sessions.workdirSet": "작업 디렉터리 설정됨: {path}",
  "sessions.workdirSetFailed": "작업 디렉터리 설정 실패: {message}",
  "sessions.deleteConfirm": '세션 "{name}"의 데이터를 삭제할까요? 생성된 산출물은 유지됩니다.',
  "sessions.deleted": "세션이 삭제되었습니다. 생성된 산출물은 유지됩니다",
  ...
  "settings.prefs.attentionHint": "입력이 필요하거나 응답이 완료될 때 알림 방법을 선택합니다.",
  "settings.prefs.inAppIndicators": "앱 내 표시",
  "settings.prefs.inAppIndicatorsHint":
    "페이지 제목, 대화 탭, 브라우저 아이콘에 상태를 표시합니다.",
  "settings.prefs.allowNotifications": "알림 허용",
  "settings.prefs.notificationEnabledHint": "시스템 알림 전송이 활성화되었습니다.",
  "settings.prefs.desktopOnly": "kt app 전용",
  "settings.prefs.notificationPermission.default": "권한 없음",
  ...
  "settings.prefs.systemNotifications": "시스템 알림",
  "settings.prefs.systemNotificationsHint": "페이지가 백그라운드일 때 운영 체제 알림을 표시합니다.",
  "settings.prefs.notifyWaiting": "입력 필요 시 알림",
  "settings.prefs.notifyWaitingHint": "질문이나 승인 대기 시 시스템 알림을 보냅니다.",
  ...
  "attention.notify.completedTitle": "KohakuTerrarium 응답 완료",
  "attention.notify.completedBody": "{target}에 새로운 응답이 있습니다.",
  "attention.notify.completedBodySummary": "{target}에 새로운 응답이 있습니다: {summary}",
  "settings.prefs.attentionSound": "알림 소리",
  "settings.prefs.attentionSoundHint": "브라우저 오디오가 활성화된 뒤 짧은 로컬 소리를 재생합니다.",
  "settings.prefs.soundWaiting": "입력 대기 소리",
  "settings.prefs.soundWaitingHint": "질문이나 승인 대기 시 소리를 재생합니다.",
  "settings.prefs.soundCompletion": "완료 소리",
  "settings.prefs.soundCompletionHint": "일반 완료에도 소리를 재생합니다.",
  "settings.prefs.faviconBadge": "파비콘 상태",
  "settings.prefs.faviconBadgeHint": "브라우저 아이콘에 입력 대기 또는 읽지 않은 수를 표시합니다.",
  "settings.prefs.desktopAttention": "데스크톱 창 알림",
  "settings.prefs.desktopAttentionHint": "비활성 kt app 창을 깜박이거나 강조합니다.",
  ...
  "settings.grok.hint": "로컬 Grok CLI 또는 OpenCode xAI 로그인을 재사용합니다",
  "settings.grok.reusing": "{source} 로그인을 재사용 중",
  "settings.grok.missing": "재사용 가능한 Grok 구독 로그인을 찾을 수 없습니다",
  ...
  "chat.bgResultTool": "백그라운드 도구 결과 도착: {label}",
  "chat.bgResultSubagent": "백그라운드 서브에이전트 결과 도착: {label}",
  "chat.processingStreaming": "KohakUwUing... (스트리밍 중)",
  "chat.processingStreamingBg": "KohakUwUing... (스트리밍 중 + 백그라운드 {n}개)",
  "chat.processingWaitingBg": "KohakUwUing... (백그라운드 {n}개 대기 중)",
  "chat.queued": "대기 중",
  "chat.selectTab": "탭 선택...",
  ...
  "state.noDrives": "이 크리처에는 아직 드라이브가 없습니다.",
  "state.noDrivesInGraph": "이 그래프에는 아직 드라이브가 없습니다.",
  "state.drivesUnavailable": "이 노드에서는 Drive 런타임이 활성화되어 있지 않습니다.",
  "state.newGoal": "새 목표",
  "state.openDrivesPanel": "전체 패널 열기",
  "state.drivesScope.mine": "이 크리처",
  "state.drivesScope.graph": "전체 그래프",
  ...
  "status.noCreatures": "이 세션에 크리처가 없습니다.",
  "status.startCreature": "시작",
  "status.stopCreature": "중지",
  "status.creatureModel": "{name}의 모델",
  "status.graphGrew": "마지막으로 본 이후 그래프가 커졌습니다",
  "status.channels": "채널",
  ...
  "layout.panel.overview": "개요",
  "layout.panel.jobs": "작업",
  "layout.panel.editorStatus": "편집기 상태",
  "layout.panel.creatureState": "크리처 상태",
  "layout.panel.modules": "모듈",
  "layout.panel.drives": "드라이브",
  "layout.panelDesc.chat": "포커스된 크리처와의 대화.",
  "layout.panelDesc.overview": "세션 정보, 모델, 토큰, 작업을 한 화면에서.",
  "layout.panelDesc.status": "세션, 크리처, 토큰, 작업, 모듈을 하나의 레일에.",
  "layout.panelDesc.editor": "워크스페이스 코드 편집기.",
  "layout.panelDesc.files": "워크스페이스 파일 트리와 크리처가 수정한 파일.",
  "layout.panelDesc.jobs": "모델, 컨텍스트 사용량, 실행 중인 작업.",
  "layout.panelDesc.settings": "인스턴스별 설정.",
  "layout.panelDesc.creatureState": "포커스된 크리처의 드라이브, 스크래치패드, 메모리 검색, 압축.",
  "layout.panelDesc.creatures": "다중 크리처 세션의 그래프 멤버와 채널.",
  "layout.panelDesc.canvas": "크리처가 생성한 이미지와 산출물.",
  "layout.panelDesc.debug": "런타임 로그와 진단.",
  "layout.panelDesc.terminal": "크리처 작업 디렉터리의 터미널.",
  "layout.panelDesc.modules": "도구, 플러그인, 트리거 등 런타임 모듈.",
  "layout.panelDesc.drives": "세션의 모든 드라이브와 전체 관리.",
