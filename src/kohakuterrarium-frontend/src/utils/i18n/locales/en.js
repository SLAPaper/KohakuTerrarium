export default {
  ...
  "settings.oauth.ready": "Credential ready",
  "settings.oauth.configured": "Configured",
  "settings.oauth.missing": "Not signed in",
  "settings.oauth.pending": "Awaiting refresh",
  "settings.oauth.expired": "Expired",
  "settings.oauth.unsupported": "Unsupported",
  "settings.oauth.attention": "Needs attention",
  "settings.oauth.failed": "Check failed",
  "settings.oauth.checking": "Checking…",
  "settings.oauth.agySource": "Reuse the local agy login",
  "settings.oauth.borrowed": "Reuse the {source} login",
  "settings.oauth.autoRefresh": "Credentials will refresh automatically when next used.",
  "settings.oauth.grokLogin": "Sign in through Grok CLI or OpenCode, then check again.",
  "settings.oauth.adminRequired": "Administrator access is required to check credentials.",
  "settings.oauth.checkFailed": "Could not check credentials. Check the connection and try again.",
  "settings.providers.oauthTitle": "OAuth sign-in",
  "settings.providers.oauthHint": "Sign in to an account or reuse credentials from a local client.",
  "settings.providers.keysTitle": "API keys",
  "settings.providers.customHint": "Configure a proxy or a self-hosted model service.",
  "settings.providers.connectionDetails": "Connection details",
  "settings.providers.unconfigured": "Not configured",
  "settings.providers.changeKey": "Change key",
  "settings.providers.more": "More actions",
  ...
  "settings.antigravity.expired":
    "Credentials have expired and agy is unavailable. Install agy and sign in again.",
  ...
  "sessions.deleteConfirm":
    'Delete session data for "{name}"? Generated artifacts will be retained.',
  "sessions.deleted": "Session deleted; generated artifacts retained",
  ...
  "settings.providers.description": "Manage sign-in methods and connections to model services.",
  ...
  "attention.notify.completedTitle": "KohakuTerrarium completed",
  "attention.notify.completedBody": "{target} has a response ready.",
  "attention.notify.completedBodySummary": "{target} has a response ready: {summary}",
  ...
  "settings.grok.hint": "Reuses a local Grok CLI or OpenCode xAI login",
  "settings.grok.reusing": "Reusing {source} login",
  "settings.grok.missing": "No reusable Grok subscription login found",
  ...
  "settings.account.grok.weekly": "Weekly shared quota",
  "settings.account.grok.monthly": "Monthly shared quota",
  "settings.account.grok.unknownPeriod": "Shared quota",
  "settings.account.grok.remaining": "{value}% remaining",
  "settings.account.grok.remainingUnknown": "Remaining unknown",
  "settings.account.grok.resetUnknown": "Reset time unknown",
  "settings.account.grok.capturedUnknown": "Capture time unknown",
  "settings.account.grok.unknown": "Unknown",
  ...
  "settings.account.grok.notLoggedIn":
    "Not logged into Grok. Sign in with the Grok CLI on this node.",
  "settings.account.grok.authExpired":
    "Grok sign-in expired. Sign in again with the Grok CLI on this node.",
  "settings.account.grok.unsupported": "Grok usage isn't available for this credential.",
  "settings.account.grok.unavailable": "Grok usage is temporarily unavailable.",
  "settings.account.grok.noData": "No Grok usage has been captured yet.",
  ...
  "chat.processingStreaming": "KohakUwUing... (streaming)",
  "chat.processingStreamingBg": "KohakUwUing... (streaming + {n} background)",
  "chat.processingWaitingBg": "KohakUwUing... (waiting on {n} background)",
  "chat.queued": "queued",
  ...
  "state.noDrives": "No drives for this creature yet.",
  "state.noDrivesInGraph": "No drives in this graph yet.",
  "state.drivesUnavailable": "The Drive runtime is not enabled on this node.",
  "state.newGoal": "New goal",
  "state.openDrivesPanel": "Open full panel",
  "state.drivesScope.mine": "this creature",
  "state.drivesScope.graph": "whole graph",
  ...
  "status.noCreatures": "No creatures in this session.",
  "status.startCreature": "Start",
  "status.stopCreature": "Stop",
  "status.creatureModel": "Model for {name}",
  "status.graphGrew": "The graph grew since you last looked",
  ...
  "layout.panel.overview": "Overview",
  "layout.panel.jobs": "Jobs",
  "layout.panel.editorStatus": "Editor Status",
  "layout.panel.creatureState": "Creature State",
  "layout.panel.modules": "Modules",
  "layout.panel.drives": "Drives",
  "layout.panelDesc.chat": "The conversation with the focused creature.",
  "layout.panelDesc.overview": "Session identity, model, tokens, and jobs on one scroll.",
  "layout.panelDesc.status": "Session, creatures, tokens, jobs, and modules in one rail.",
  "layout.panelDesc.editor": "Code editor for the workspace.",
  "layout.panelDesc.files": "Workspace file tree and files the creature touched.",
  "layout.panelDesc.jobs": "Model, context usage, and running jobs.",
  "layout.panelDesc.settings": "Per-instance settings.",
  "layout.panelDesc.creatureState":
    "Drives, scratchpad, memory search, and compaction for the focused creature.",
  "layout.panelDesc.creatures": "Graph members and channels for a multi-creature session.",
  "layout.panelDesc.canvas": "Images and artifacts the creature produced.",
  "layout.panelDesc.debug": "Runtime logs and diagnostics.",
  "layout.panelDesc.terminal": "A terminal in the creature's working directory.",
  "layout.panelDesc.modules": "Tools, plugins, triggers, and other runtime modules.",
  "layout.panelDesc.drives": "Every drive in the session with full management.",
  ...
  "shell.rail.closeInspector": "Close inspector",
  "shell.rail.detachAll": "Detach all tabs",
  "shell.rail.endConversation": "End conversation",
  "shell.rail.endConfirm": "End this conversation? Its saved history will remain available.",
  "shell.rail.endError": "Failed to end conversation",
  ...
  "shell.stats.sessionData": "Session data",
  "shell.stats.generatedMedia": "Generated media",
  ...
  "chat.tool.savedArtifacts": "Saved artifacts",
  ...
  // ── Host picker (L1 — backend host the frontend talks to) ─────────
  "hostPicker.title": "Backend host",
  "hostPicker.chipTitle": ({ name }) => `Backend host: ${name}`,
  "hostPicker.sameOrigin": "Same origin",
  "hostPicker.sameOriginHint": "Talk to the host that served this page",
  "hostPicker.listTitle": "Saved hosts",
  "hostPicker.tokenSet": "token set",
  "hostPicker.add": "Add host",
  "hostPicker.edit": "Edit host",
  "hostPicker.name": "Name",
  "hostPicker.namePlaceholder": "My home server",
  "hostPicker.url": "URL",
  "hostPicker.urlPlaceholder": "http://kt.home.lan:8001",
  "hostPicker.token": "Token",
  "hostPicker.tokenOptional": "(optional)",
  "hostPicker.tokenPlaceholder": "kt-host-token",
  "hostPicker.submitAdd": "Add & activate",
  "hostPicker.submitEdit": "Save",
  "hostPicker.qrTitle": "Or scan / paste the host QR",
  "hostPicker.qrFromUri": ({ host }) => `Applied host from QR: ${host}`,
  "hostPicker.qrFailed": ({ error }) => `Failed to apply QR URI: ${error}`,
  "hostPicker.removeConfirm": ({ name }) => `Remove host "${name}"?`,
  "hostPicker.activate": "Activate",
  ...
  "codexLogin.starting": "Starting authentication…",
  "codexLogin.step1Label": "1. Open this URL in any browser:",
  "codexLogin.step1Hint": "Use this device, your phone, or any device with a browser.",
  "codexLogin.step2Label": "2. Enter this code on that page:",
  "codexLogin.step3Label": "3. Once you authorise on that page, this dialog will close.",
  "codexLogin.copy": "Copy",
  "codexLogin.copied": "Copied!",
  "codexLogin.copyManual": "Long-press to copy",
